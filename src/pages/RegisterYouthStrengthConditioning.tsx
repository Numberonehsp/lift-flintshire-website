...
const FORM_NAME = 'register-youth-strength-conditioning'
...
function RegistrationFormContent() {
    ...
    return (
      <div className="bg-teal-pale rounded-card p-10 max-w-xl mx-auto">
        ...
        <p className="font-body text-base text-ink-light mb-6 leading-relaxed">
          Thank you for registering. We're looking forward to welcoming the young person to a Youth Strength & Conditioning session.
        </p>
        <div className="mb-6">
  ...
  return (
    ...
    >
      ...
      <input type="hidden" name="programme" value="youth-strength-conditioning" />

      <div className="bg-teal-pale border border-teal/20 rounded-card p-4">
        <p className="font-body text-sm text-ink leading-relaxed">
          <strong>This form is for parents and guardians</strong> to register a young person for our free Youth Strength &amp; Conditioning session.
...
export default function RegisterYouthStrengthConditioning() {
  return (
    <>
      <Seo
          ...
          <div className="space-y-6">
            <div className="bg-teal-pale rounded-card p-4 border border-teal/20">
              ...
              <ul className="font-body text-sm text-ink-light space-y-1">
                <li><strong className="text-ink">Who:</strong> Young people in Years 7–13 (ages 11–18)</li>
                <li><strong className="text-ink">Time:</strong> Thursdays, 11:00–12:00</li>
                <li><strong className="text-ink">Location:</strong> Number One HSP, CH5 2TF, Flintshire</li>
